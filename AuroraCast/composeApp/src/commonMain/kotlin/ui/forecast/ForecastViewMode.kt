...
class ForecastViewMode(private val city: String) : ViewModel() {
    ...
    fun getForecast() {
        viewModelScope.launch {
            ...
            val location = fetchWeatherForCity(city)
            try {
    ...
    private suspend fun fetchWeatherForCity(city: String): LatLng {
...
sealed class ForecastState {
    ...
    data class Data(val dailyData: List<ForecastData>?, val weeklyDay: List<ForecastData>) :
        ForecastState()
